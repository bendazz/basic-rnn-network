...
### Current Features
- SVG rendering of N input and N output nodes (hidden size 1–5).
- Fully connected edges with arrowheads.
- Hidden size slider dynamically rebuilds the layer (pre-activation) structure.
